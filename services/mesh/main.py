...
import setup                    # services/mesh/setup.py
import heartbeat                # services/mesh/heartbeat.py
from intel import orchestrator  # services/mesh/intel/orchestrator.py


SERVICE_NAME = os.getenv("SERVICE_ID", "mesh")

# Read debug flag once from env
DEBUG_ENABLED = os.getenv("DEBUG_MESH", "false").lower() == "true"
...
def log(level: str, message: str, emoji: str = "", component: str = SERVICE_NAME) -> None:
    ...
    DEBUG lines are suppressed unless DEBUG_MESH=true.
    """
