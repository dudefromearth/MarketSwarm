...
import setup                    # services/mmaker/setup.py
import heartbeat                # services/mmaker/heartbeat.py
from intel import orchestrator  # services/mmaker/intel/orchestrator.py
...
def log(level: str, message: str, emoji: str = "", component: str = SERVICE_NAME) -> None:
    ...
    DEBUG lines are suppressed unless DEBUG_MMAKER=true.
    """
