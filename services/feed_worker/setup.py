...
def setup(service_name: str = "feed_worker") -> Dict[str, Any]:
    """
    Initialize the feed_worker service from Truth stored in Redis.

    - Loads Truth from Redis
    - Extracts the 'feed_worker' component definition
