...
import setup                    # services/feed_worker/setup.py
import heartbeat                # services/feed_worker/heartbeat.py
from intel import orchestrator  # services/feed_worker/intel/orchestrator.py


SERVICE_NAME = os.getenv("SERVICE_ID", "feed_worker")
...
def log(level: str, message: str, emoji: str = "", component: str = SERVICE_NAME) -> None:
    ...
    DEBUG lines are suppressed unless DEBUG_FEED_WORKER=true.
    """
