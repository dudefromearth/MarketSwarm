...
def setup(service_name: str = "healer") -> Dict[str, Any]:
    """
    Initialize the healer service from Truth stored in Redis.

    - Loads Truth from Redis
    - Extracts the 'healer' component definition
    ...
    config: Dict[str, Any] = {
        ...
        "inputs": inputs,    # healer subscribes to other services' heartbeats
        "outputs": outputs,  # healer:heartbeat, healer:alerts, etc.
        "models": {
