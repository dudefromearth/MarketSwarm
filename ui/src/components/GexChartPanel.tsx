      ...
      <div className="gex-chart-body">
        ...
        <div className="dealer-gravity-indicators">
          ...
          <div className="dg-indicator">
            ...
            <div className="dg-indicator-mode-toggle">
              <button
                className={`dg-mode-btn ${gexConfig.mode === 'combined' ? 'active' : ''}`}
                onClick={() => setGexConfig(c => ({ ...c, mode: 'combined' }))}
              >
                C/P
              </button>
              <button
                className={`dg-mode-btn ${gexConfig.mode === 'net' ? 'active' : ''}`}
