 ...
 */
export function getPositionTypeCode(positionType: PositionType): string {
 ...
 */
export function getPositionTypeColor(positionType: PositionType): string {
 ...
 */
export function getPositionTypeLabel(positionType: PositionType): string {
 ...
 */
export function formatExpiration(expiration: string, includeYear = false): string {
 ...
 */
export function hasMultipleExpirations(legs: PositionLeg[]): boolean {
 ...
 */
export function getUniqueExpirations(legs: PositionLeg[]): string[] {
  const expirations = [...new Set(legs.map(l => l.expiration))];
 ...
 */
export function formatCostBasis(value: number | null, type?: 'debit' | 'credit'): string {
