 ...
 */
function parseTosExpiration(dateStr: string): string {
...
function parseTosComponents(
  ...
  const primaryRight: 'call' | 'put' = rightUpper.startsWith('CALL') ? 'call' : 'put';
  const costBasisType: CostBasisType = isBuy ? 'debit' : 'credit';
 ...
 */
export function parseTosScript(script: string): ParsedPosition | null {
 ...
 */
export function getTosExamples(): string[] {
  return [
    'BUY +1 BUTTERFLY SPX 100 17 JAN 25 5880/5900/5920 CALL @1.20',
    'SELL -1 VERTICAL SPX 100 17 JAN 25 5900/5920 PUT @2.50',
    'BUY +1 IRON CONDOR SPX 100 19 JAN 25 5800/5850/5950/6000 CALL/PUT @3.80',
